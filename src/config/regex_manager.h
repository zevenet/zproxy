...
namespace regex_set
{
	...
	static const Regex
		Threads("^[ \t]*Threads[ \t]+([1-9][0-9]*)[ \t]*$");
	static const Regex
		ThreadModel("^[ \t]*ThreadModel[ \t]+(pool|dynamic)[ \t]*$");
	static const Regex
		LogFacility("^[ \t]*LogFacility[ \t]+([a-z0-9-]+)[ \t]*$");
	...
	static const Regex
		ControlIP("^[ \t]*ControlIP[ \t]+([^ \t]+)[ \t]*$");
	static const Regex
		ControlPort("^[ \t]*ControlPort[ \t]+([1-9][0-9]*)[ \t]*$");
	static const Regex
		ControlUser("^[ \t]*ControlUser[ \t]+\"(.+)\"[ \t]*$");
	static const Regex
		ControlGroup("^[ \t]*ControlGroup[ \t]+\"(.+)\"[ \t]*$");
	static const Regex
		ControlMode("^[ \t]*ControlMode[ \t]+([0-7]+)[ \t]*$");
	...
	static const Regex
		CacheTO("^[ \t]*CacheTO[ \t]+([1-9][0-9]*)[ \t]*$");
	static const Regex
		CacheRamSize
		("^[ \t]*CacheRamSize[ \t]+([1-9][0-9]*)([gmkbGMKB]*)[ \t]*$");
	static const Regex
		CacheThreshold
		("^[ \t]*CacheThreshold[ \t]+([1-9][0-9]*)[ \t]*$");
	static const Regex
		MaxSize("^[ \t]*MaxSize[ \t]+([1-9][0-9]*)[ \t]*$");
	static const Regex
		CacheRamPath
		("^[ \t]*CacheRamPath[ \t]+\"([a-zA-Z\\/\\._]*)\"[ \t]*$");
	static const Regex
		CacheDiskPath
