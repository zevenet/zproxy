...
public:
     ...
     */
    virtual st::STORAGE_STATUS initCacheStorage(const size_t max_size, double st_threshold, const std::string &svc, const std::string &mount_point) = 0;
    /**
     ...
     */
    virtual st::STORAGE_STATUS initServiceStorage( const std::string &svc ) = 0;
    /**
     ...
     * @return STORAGE_STATUS return the status of the storage
     */
    virtual st::STORAGE_STATUS putInStorage( const std::string &rel_path, std::string_view buffer, size_t response_size) = 0;
    /**
     ...
     * @return STORAGE_STATUS return the status of the storage
     */
    virtual st::STORAGE_STATUS appendData(const std::string &rel_path, std::string_view buffer) = 0;
    /**
