...
class ICacheStorage
{
     ...
     */
	virtual st::STORAGE_STATUS initServiceStorage(const std::
						      string & svc) = 0;
    /**
     ...
     * @return STORAGE_STATUS return the status of the storage
     */
	virtual st::STORAGE_STATUS getFromStorage(const std::
						  string & rel_path,
     ...
     * @return STORAGE_STATUS return the status of the storage
     */
	virtual st::STORAGE_STATUS deleteInStorage(const std::string & url) =
		0;
    /**
