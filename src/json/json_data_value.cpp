...
json::JsonDataValue::JsonDataValue(const json::JsonDataValue &&value) noexcept { setValue(value); }
...
json::JsonDataValue::JsonDataValue(int value) { setValue(static_cast<long>(value)); }
json::JsonDataValue::JsonDataValue(unsigned int value) { setValue(static_cast<long>(value)); }
