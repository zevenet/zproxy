...
std::unique_ptr<json::JsonDataValue> json::JsonParser::parseJsonValue(std::istringstream &ss) {
  return nullptr;
}
std::unique_ptr<json::JsonData> json::JsonParser::parseJsonData(std::istringstream &ss) {
  return nullptr;
}
std::unique_ptr<json::JsonDataValue> json::JsonParser::parseJsonDataValue(
