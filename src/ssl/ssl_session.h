...
class SslSessionManager {
 public:
  ...
  SSL_SESSION *getSession(SSL *ssl, const unsigned char *id, int id_length, int *do_copy);
  ...
  static SSL_SESSION *getSessionCb(SSL *ssl, const unsigned char *id, int id_length, int *do_copy);
