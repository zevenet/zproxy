...
struct validation {
  ...
  static const std::unordered_map<REQUEST_RESULT, const std::string> request_result_reason;
...
enum class Code {
  ...
  UnsupportedMediaType = 415 /*[RFC7231, Section 6.5.13] [RFC7694, Section 3]*/,
...
static const char *reasonPhrase(int code) { return reasonPhrase(static_cast<Code>(code)); }

static inline std::string getHttpResponse(Code status_code, const std::string &status_code_string,
