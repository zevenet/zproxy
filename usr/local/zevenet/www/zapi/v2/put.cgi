...
sub modify_farm()
{
	...
	{
		require "/usr/local/zevenet/www/zapi/v2/put_http.cgi";
	}

	if ( $type eq "l4xnat" )
	{
		require "/usr/local/zevenet/www/zapi/v2/put_l4.cgi";
	}

	if ( $type eq "datalink" )
	{
		require "/usr/local/zevenet/www/zapi/v2/put_datalink.cgi";
	}

	if ( $type eq "gslb" )
	{
		require "/usr/local/zevenet/www/zapi/v2/put_gslb.cgi";
	}

	if ( $type eq "tcp" || $type eq "udp" )
	{
		require "/usr/local/zevenet/www/zapi/v2/put_tcp.cgi";
	}
}
