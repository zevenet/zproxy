...
#       -u zapi:<password> -d '{"action":"stop"}' https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmTCP/actions
#
...
# POST maintenance
#
# curl --tlsv1  -k -X POST -H 'Content-Type: application/json' -H "ZAPI_KEY: 2bJUdMSHyAhsDYeHJnVHqw7kgN3lPl7gNoWyIej4gjkjpkmPDP9mAU5uUmRg4IHtT" -u zapi:admin -d '{"action":"up", "service":"service1", "id":"1"}' https://46.101.46.14:444/zapi/v2/zapi.cgi/farms/FarmHTTP/maintenance
#
#
...
#       https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmHTTP/maintenance
#
# @apiSampleRequest off
#
#**
