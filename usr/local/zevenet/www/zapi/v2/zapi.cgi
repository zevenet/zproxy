...
require "/usr/local/zevenet/www/zapi/v2/global.cgi";
require "/usr/local/zevenet/www/zapi/v2/certificates.cgi";
require "/usr/local/zevenet/config/global.conf";
require "/usr/local/zevenet/www/zapi/v2/get.cgi";
require "/usr/local/zevenet/www/zapi/v2/post.cgi";
require "/usr/local/zevenet/www/zapi/v2/put.cgi";
require "/usr/local/zevenet/www/zapi/v2/delete.cgi";
require "/usr/local/zevenet/www/zapi/v2/delete_gslb.cgi";
require "/usr/local/zevenet/www/zapi/v2/interface.cgi";
require "/usr/local/zevenet/www/zapi/v2/system_stats.cgi";
require "/usr/local/zevenet/www/zapi/v2/farm_guardian.cgi";
require "/usr/local/zevenet/www/zapi/v2/farm_actions.cgi";
require "/usr/local/zevenet/www/zapi/v2/post_gslb.cgi";
