...
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmGSLB/zones/myzone.com
#
...
# @apiExample {curl} Example Usage:
#       curl --tlsv1 -k -X DELETE -H 'Content-Type: application/json' -H "ZAPI_KEY: <ZAPI_KEY_STRING>"
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmGSLB/zones/myzone.com/resources/2
#
# @apiSampleRequest off
#
#**
