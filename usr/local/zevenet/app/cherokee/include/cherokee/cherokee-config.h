...
/* configure arguments */
#define CHEROKEE_CONFIG_ARGS " '--prefix=/usr/local/zevenet/app/cherokee/' '--disable-ipv6' '--with-wwwroot=/usr/local/zevenet/www' '--with-cgiroot=/usr/local/zevenet/www' '--with-wwwuser=root'"
