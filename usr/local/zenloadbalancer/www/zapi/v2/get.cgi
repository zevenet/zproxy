...
require "/usr/local/zenloadbalancer/www/zapi/v2/get_tcp.cgi";
require "/usr/local/zenloadbalancer/www/zapi/v2/get_http.cgi";
require "/usr/local/zenloadbalancer/www/zapi/v2/get_gslb.cgi";
require "/usr/local/zenloadbalancer/www/zapi/v2/get_l4.cgi";
require "/usr/local/zenloadbalancer/www/zapi/v2/get_datalink.cgi";
...
#	-u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms
#
