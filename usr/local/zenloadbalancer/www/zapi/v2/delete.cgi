...
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmTCP
#
...
# @apiExample {curl} Example Usage:
#       curl --tlsv1 -k -X DELETE -H 'Content-Type: application/json' -H "ZAPI_KEY: <ZAPI_KEY_STRING>"
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/FarmGSLB/services/service1
#
# @apiSampleRequest off
#
#**
...
# @apiExample {curl} Example Usage:
#       curl --tlsv1 -k -X DELETE -H 'Content-Type: application/json' -H "ZAPI_KEY: <ZAPI_KEY_STRING>"
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/L4FARM/backends/4
#
# @apiSampleRequest off
#
#**
...
# @apiExample {curl} Example Usage:
#       curl --tlsv1 -k -X DELETE -H 'Content-Type: application/json' -H "ZAPI_KEY: <ZAPI_KEY_STRING>"
#       -u zapi:<password> https://<zenlb_server>:444/zapi/v2/zapi.cgi/farms/newfarmHTTP/services/service1/backends/4
#
# @apiSampleRequest off
#
#**
