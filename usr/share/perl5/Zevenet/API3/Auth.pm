...
sub validCGISession    # ()
{
	...
	#~ &zenlog( "CGI SESSION ID: " . Dumper $session, "info", "ZAPI" );
	#~ &zenlog( "CGI SESSION ID: " . $session->id, "info", "ZAPI" ) if $session->id;
	#~ &zenlog( "session data: " . Dumper $session->dataref(), "info", "ZAPI" ); # DEBUG
