...
\tnotify_master \"/usr/local/zevenet/bin/enterprise.bin zcluster-manager notify_master\"
\tnotify_backup \"/usr/local/zevenet/bin/enterprise.bin zcluster-manager notify_backup\"
\tnotify_fault  \"/usr/local/zevenet/bin/enterprise.bin zcluster-manager notify_fault\"
\tnotify        \"/usr/local/zevenet/bin/enterprise.bin zcluster-manager\"
}
